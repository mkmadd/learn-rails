...
window.analytics.methods = ['identify', 'track', 'trackLink', 'trackForm', 'trackClick', 
                            'trackSubmit', 'page', 'pageview', 'ab', 'alias', 'ready', 
                            'group', 'on', 'once', 'off'];
...
// to load asyncronously to actually track things.  The 'method' is always the 
...
// Define a method that will asynchronously load anaylitics.js from our CDN.
window.analytics.load = function(apiKey) {
  
  // Create an asyn script element for anlytics.js based on your API key.
...
window.analytics.load('t5gp4haj5b');
